      ...
      <div className="grid grid-cols-1 min-[700px]:grid-cols-2 md:grid-cols-3 justify-items-center gap-x-5 gap-y-10">
        ...
        <div className=" w-[100%] col-span-1 min-[700px]:col-span-2 md:col-span-3">
          ...
          <textarea
            ...
            className="bg-[#262626] py-3  w-[100%] rounded-md px-3 ring-1 ring-gray-700 focus:outline focus:outline-[#e22221]"
  ...
  return (
    <div className=" w-[100%]">
      ...
      <input
        ...
        className="bg-[#262626] h-[40px] w-[100%] rounded-md px-3 ring-1 ring-gray-700 focus:outline focus:outline-[#e22221]"
        value={state[type]}
