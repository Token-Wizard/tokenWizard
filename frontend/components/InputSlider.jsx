  ...
  return (
    <div>
      <label className="relative inline-block h-7 w-[70px] ">
        ...
        />
        <span className="z-0 absolute inset-x-0 inset-y-0 cursor-pointer bg-black rounded-lg transition before:transition before:rounded-lg before:content-[''] before:absolute before:h-full before:w-8 before:left-0  before:duration-400 before:bg-[#e22221] peer-checked:before:translate-x-[38px]  flex justify-around items-center">
