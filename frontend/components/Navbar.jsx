    ...
    <>
      <nav className="bg-black h-[70px] text-white flex items-center justify-between px-10 md:px-[5%] lg:px-[10%] border-b-[1px] border-gray-700 fixed top-0 z-10 w-[100%]">
        ...
        <ul className="hidden lg:flex">
          <li className="cursor-pointer mr-[50px] relative before:content-[''] before:absolute before:bottom-0 before:w-[0%] before:h-[2px] before:bg-[#ff0000] hover:before:w-[100%] before:transition-width before:duration-500">
            <a href="/">Home</a>
          </li>
          <li className="cursor-pointer mr-[50px] relative before:content-[''] before:absolute before:bottom-0 before:w-[0%] before:h-[2px] before:bg-[#ff0000] hover:before:w-[100%] before:transition-width before:duration-500">
            <a href="/dashboard">Dashboard</a>
          </li>
          <li className="cursor-pointer relative before:content-[''] before:absolute before:bottom-0 before:w-[0%] before:h-[2px] before:bg-[#ff0000] hover:before:w-[100%] before:transition-width before:duration-500">
