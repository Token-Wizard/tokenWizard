...
const Home = () => {
  return (
    <>
      <Head>
        <title>A token deployer for Shido Blockchain</title>
        <meta
          name="Shido Token Deployer"
          content="Token Deployer for the Shido Blockchain"
        />
            ...
            <div className="flex flex-col space-y-3 md:space-y-0 md:space-x-6 md:flex-row  ">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Connect your wallet to deploy your token on Shido
                  chain.
                </p>
              </div>
            </div>
